...
export default function ProcessosPage() {
    ...
    const loadData = async () => {
        if (isCheckingUpload || uploading) return; // Prevent fetching ghost data during upload
    ...
    useEffect(() => {
        loadData();
    }, [page, search, typeFilter, statusFilter, dateRange, onlyDelayed, refreshKey, isCheckingUpload, uploading]);
    ...
    useEffect(() => {
        ...
        const checkUpload = async () => {
            try {
                ...
                setIsCheckingUpload(false); // Done checking, safe to load data if not uploading
            }
        };
        checkUpload();
